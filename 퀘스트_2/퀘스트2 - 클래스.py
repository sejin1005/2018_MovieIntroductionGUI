...
class PythonCinema:
    ...
    def open_2018(self):
        ...
        movie_1 = PhotoImage(file = "image/movie_2018/1.png")
        movie_2 = PhotoImage(file = "image/movie_2018/2.png")
        movie_3 = PhotoImage(file = "image/movie_2018/3.png")
            
        self.v1 = IntVar()
        rb1 = Radiobutton(movie_2018, image = movie_1,variable = self.v1, value = 0, command = self.myRb_select)
        rb2 = Radiobutton(movie_2018, image = movie_2,variable = self.v1, value = 1, command = self.myRb_select)
        rb3 = Radiobutton(movie_2018, image = movie_3 ,variable = self.v1, value = 2, command = self.myRb_select)
    ...
    def open_select(self):
        ...
        movie_1 = PhotoImage(file = "image/movie_select/1.png")
        movie_2 = PhotoImage(file = "image/movie_select/2.png")
        movie_3 = PhotoImage(file = "image/movie_select/3.png")

        self.v1 = IntVar()
        rb1 = Radiobutton(movie_select, image = movie_1,variable = self.v1, value = 0, command = self.myRb_select)
        rb2 = Radiobutton(movie_select, image = movie_2,variable = self.v1, value = 1, command = self.myRb_select)
        rb3 = Radiobutton(movie_select, image = movie_3,variable = self.v1, value = 2, command = self.myRb_select)
